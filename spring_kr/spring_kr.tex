    ...
    \section*{Задача \textnumero 2}
        \begin{proof}[Решение.]
          \begin{itemize}
              ...
              \item $\alpha_1(f) = (1 1 0)\left(\begin{matrix}
                  1 & 0 & 1 \\
                  0 & 1 & 0 \\
                  1 & 3 & 2 \\ 
              \end{matrix}\right) \left(\begin{matrix}
                  ...
                  b\\
                  c \\  
              \end{matrix}\right) = (1 1 1) \left(\begin{matrix}
                  a \\
                  b\\
                  c\\  
              \end{matrix}\right) = a + b + c$
              \item  $\alpha_2(f) = (0 -2 1)\left(\begin{matrix}
                1 & 0 & 1 \\
                0 & 1 & 0 \\
                1 & 3 & 2 \\ 
            \end{matrix}\right) \left(\begin{matrix}
                ...
                b\\
                c \\  
            \end{matrix}\right) = (1 1 2) \left(\begin{matrix}
                a \\
                b\\
                c\\  
