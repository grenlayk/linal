...
\begin{document}
    ...
    \section*{Задача \textnumero 7}
	    ...
	    \begin{proof}[Решение 1.]
            ...
            Поэтому нам нужно такое значение параметра $a$, что ранг матрицы $A$ равен 2. 

            Приведем ее к улучшенному ступенчатому виду: 
        ...
        \begin{proof}[Решение 2.] (Только идея, мне лень это техать)\
            ...
            значения параметра $a$, при которых везде получается 0. (Я реально это на экзе делала, прикиньте. 
